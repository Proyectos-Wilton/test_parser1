...
describe('Chai Assertion Plugins', () => {
  context('chai-date-string', () => {
    // we installed this node_module in package.json
    ...
    it('can be used in any spec file', () => {
      expect('2015-11-12').to.be.a.dateString()
    })

    it('can be wrapped by Cypress as well',  () => {
    ...
    it('can be negated using Cypress', () => {
